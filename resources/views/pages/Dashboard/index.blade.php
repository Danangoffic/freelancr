                    ...
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        <button
                            ...
                            @if (auth()->user()->detail_user->photo != null)
                                ...
                                src="{{url(Storage::url(auth()->user()->detail_user->photo))}}" alt="avatar">
                            @else
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="p-4 lg:col-span-7 md:col-span-12 md:pt-0">
                    <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{asset('images/services-progress-icon.svg')}}" alt="" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{asset('images/services-completed-icon.svg')}}" alt="" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{asset('images/new-freelancer-icon.svg')}}" alt="" class="w-8 h-8">
                                </div>
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if (auth()->user()->detail_user->photo != null)
                                                        ...
                                                        src="{{url(Storage::url(auth()->user()->detail_user->photo))}}" alt="photo"
                                                        loading="lazy" />
                                                    @else
                                                        <svg class="object-cover w-full h-full rounded-full" fill="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path
                                                                d="M24 20.993V24H0v-2.996A14.977 14.977 0 0112.004 15c4.904 0 9.26 2.354 11.996 5.993zM16.002 8.999a4 4 0 11-8 0 4 4 0 018 0z" />
                                                        </svg>
                ...
                <aside class="p-4 lg:col-span-5 md:col-span-12 md:pt-0">
                    <div
                        ...
                        <img class="relative object-cover w-full h-full rounded-xl" src="/images/card-background.png"
                            alt="">
