                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Alex Jones" type="text" name="service-name" value="{{$user->detail_user->user->name}}"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Website Developer" type="text" name="service-name" value="{{$user->detail_user->role}}"
                                                id="service-name" autocomplete="service-name"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        </div>
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Alex.jones@gmail.com" type="text" name="service-name" value="{{$user->detail_user->user->email}}"
                                                id="service-name" autocomplete="service-name"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        </div>
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="087721205555" type="number" name="service-name" value="{{$user->detail_user->contact_number}}"
                                                id="service-name" autocomplete="service-name"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        </div>
                                        <div class="col-span-6">
