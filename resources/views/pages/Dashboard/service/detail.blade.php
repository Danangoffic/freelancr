    ...
    <main class="h-full overflow-y-auto">
            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                ...
                <div class="col-span-4 lg:text-right">
                    <div class="relative mt-0 md:mt-6">
                        <form action="{{route('member.service.destroy', 1)}}" method="post">
                        @method('DELETE')
                        @csrf
                        <button type="submit" class="px-4 py-2 mt-2 text-left text-white bg-red-400 rounded-xl">
                            Delete Service
                        </button>
                        </form>
                    </div>
        ...
        <nav class="mx-10 mt-8 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex p-0 list-none">
                ...
                <li class="flex items-center">
                    <a href="{{route('member.service.show', 1)}}" class="font-medium">Details Service</a>
                </li>
            </ol>
        </nav>
...
@push('after-script')
    <script>
        function gallery() {
            return {
                featured: '{{url("https://source.unsplash.com/_SgRNwAVNKw/1600x900/")}}',
                active: 1,
