                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Service apa yang ingin kamu tawarkan?" type="text"
                                                name="title" id="service-name" autocomplete="service-name"
                                        ...
                                        <div class="col-span-6">
                                            <label for="user-advantages"
                                                ...
                                                kamu</label>
                                            <input placeholder="Keunggulan 1" type="text" name="user_advatanges[]"
                                                id="user-advantages-1" autocomplete="user-advantages-1"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input placeholder="Keunggulan 2" type="text" name="user_advatanges[]"
                                                id="user-advantages-2" autocomplete="user-advantages-2"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input placeholder="Keunggulan 3" type="text" name="user_advatanges[]"
