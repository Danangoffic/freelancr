                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text" value="{{$service->description}}"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="delivery_time" name="delivery_time" autocomplete="delivery_time" required
                                                ...
                                                <option value="2" @if($service->delivery_time == 2) selected @endif>2 Hari</option>
                                                <option value="4" @if($service->delivery_time == 4) selected @endif>4 Hari</option>
                                                <option value="8" @if($service->delivery_time == 8) selected @endif>8 Hari</option>
                                                <option value="16" @if($service->delivery_time == 16) selected @endif>16 Hari</option>
                                                <option value="32" @if($service->delivery_time == 32) selected @endif>32 Hari</option>
                                                <option value="60" @if($service->delivery_time == 60) selected @endif>60 Hari</option>
                                            </select>
                                            @error('delivery_time')
                                                <p class="text-red-500 text-sm mb-3">{{ $message }}</p>
                                            @enderror
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" required
                                                class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                <option value="2" @if($service->revision_limit == 2) selected @endif>2 Revisi</option>
                                                <option value="5" @if($service->revision_limit == 5) selected @endif>5 Revisi</option>
                                                <option value="6" @if($service->revision_limit == 7) selected @endif>7 Revisi</option>
                                                <option value="10" @if($service->revision_limit == 10) selected @endif>10 Revisi</option>
                                                <option value="11"" @if($service->revision_limit == 11) selected @endif>11 Revisi</option>
                                            </select>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Hal yang ingin disampaikan oleh kamu?" type="text"
                                                name="note" id="note" autocomplete="note" value="{{$service->note}}"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            @error('note')
                                                <p class="text-red-500 text-sm mb-3">{{ $message }}</p>
                                            @enderror
    ...
    var thumbnails, nextThumbnails,
        ...
        function confirmSubmit() {
            ...
            return getConfirmCall("Are you sure want to submit this data?").then(result => {
                if(result.isConfirmed){
                    document.querySelector("form#form-update-service").submit();
                }
            });
        }
    </script>
