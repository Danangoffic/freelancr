                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Service apa yang ingin kamu tawarkan?" type="text" required
                                                name="title" id="service-name" autocomplete="service-name" value="{{old('title')}}"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan 2" type="text" name="advantages[]"
                                                id="advatange-2" autocomplete="advatange-2"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input placeholder="Keunggulan 3" type="text" name="advantages[]"
                                                id="advatange-3" autocomplete="advatange-3"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan 1" type="file" name="thumbnails[]"
                                                id="thumbnails-1" autocomplete="thumbnails-1"
                                            ...
                                            <input placeholder="Keunggulan 3" type="file" name="thumbnails[]"
                                                id="thumbnails-2" autocomplete="thumbnails-2"
                                                class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                        ...
                                        <div class="col-span-6">
                                            <label for="user-advantages"
                                                ...
                                                kamu</label>
                                            <input placeholder="Keunggulan 1" type="text" name="user_advantages[]"
                                                id="user-advantages-1" autocomplete="user-advantages-1"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input placeholder="Keunggulan 2" type="text" name="user_advantages[]"
                                                id="user-advantages-2" autocomplete="user-advantages-2"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input placeholder="Keunggulan 3" type="text" name="user_advantages[]"
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        const addServicesRow = () => {
            var html ='<input placeholder="Keunggulan" type="text" name="services[]" id="service-name" autocomplete="service-name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
